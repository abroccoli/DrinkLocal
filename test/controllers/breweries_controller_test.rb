...
class BreweriesControllerTest < ActionController::TestCase
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post :create, brewery: { hours: @brewery.hours, location: @brewery.location, name: @brewery.name, state: @brewery.state, tours_?: @brewery.tours_?, url: @brewery.url }
    end
  ...
  test "should update brewery" do
    patch :update, id: @brewery, brewery: { hours: @brewery.hours, location: @brewery.location, name: @brewery.name, state: @brewery.state, tours_?: @brewery.tours_?, url: @brewery.url }
    assert_redirected_to brewery_path(assigns(:brewery))
  end
